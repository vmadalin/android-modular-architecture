...
object Dependencies {
    ...
    const val SWIPE_REFRESH_LAYOUT = "androidx.swiperefreshlayout:swiperefreshlayout:${DependenciesVersions.SWIPE_REFRESH_LAYOUT}"
    ...
    const val PLAY_CORE = "com.google.android.play:core:${DependenciesVersions.PLAY_CORE}"
}
